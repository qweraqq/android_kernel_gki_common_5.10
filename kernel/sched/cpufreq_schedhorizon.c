...
static unsigned int default_efficient_freq[] = {1344160 , 2850100};
static u64 default_up_delay[] = {40 * NSEC_PER_MSEC, 60 * NSEC_PER_MSEC};
...
{
	return schedhorizon_cpu_util(cpu, cpu_util_cfs(cpu_rq(cpu)), max,
				  ENERGY_UTIL, NULL);
}
